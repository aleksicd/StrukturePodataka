...
public:
	...
	BSTNodeInt* findDeepestLeaf(BSTNodeInt* root);
	BSTNodeInt* deepestLeaf(BSTNodeInt* root, int currentDepth, int& maxDepth, BSTNodeInt*& deepest);
	BSTNodeInt* getDeepest();
};
