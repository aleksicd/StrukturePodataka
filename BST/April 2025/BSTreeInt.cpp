...
BSTNodeInt* BSTreeInt::findDeepestLeaf(BSTNodeInt* root)
{
	int maxDepth = -1;
	BSTNodeInt* deepest = nullptr;
	deepestLeaf(root, 0, maxDepth, deepest);
	return deepest;
}

BSTNodeInt* BSTreeInt::deepestLeaf(BSTNodeInt* root, int currentDepth, int& maxDepth, BSTNodeInt*& deepest)
{
	if (root == nullptr)
		return nullptr;
	...
	deepestLeaf(root->left, currentDepth + 1, maxDepth, deepest);
	deepestLeaf(root->right, currentDepth + 1, maxDepth, deepest);
